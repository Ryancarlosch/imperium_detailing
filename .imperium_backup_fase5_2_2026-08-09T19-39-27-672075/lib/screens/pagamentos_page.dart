...
class _PagamentoOrdemDetalhesPageState
  ...
  Future<void> _estornar(PagamentoOrdemServico pagamento) async {
    final motivo = await showDialog<String>(
      context: context,
    ...
    final sucesso = await _executar(() {
      return _repository.estornarPagamento(
    ...
    await _carregar();
    _mensagem('Pagamento estornado e financeiro atualizado.');
  }
        ...
        child: Column(
          ...
          children: [
            ...
            if (pagamento.motivoEstorno.isNotEmpty) ...[
              const SizedBox(height: 7),
              Text(
                'Motivo do estorno: ${pagamento.motivoEstorno}',
                style: const TextStyle(color: Colors.white60, fontSize: 12),
              ),
            ],
