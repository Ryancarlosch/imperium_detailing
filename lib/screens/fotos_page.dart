...
class _FotosPageState extends State<FotosPage> {
  ...
  Future<void> carregarFotos() async {
    try {
      final lista =
      await _repository.listarFotosComDetalhes();
  ...
  void filtrarFotos() {
    ...
    final pesquisa = _pesquisaController.text
        .trim()
        .toLowerCase();
  ...
  Widget criarCardFoto(
      Map<String, dynamic> foto,
      ) {
    final caminhoMiniatura =
    obterCaminhoMiniatura(foto);
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText:
                'Pesquisar cliente, veículo ou placa',
