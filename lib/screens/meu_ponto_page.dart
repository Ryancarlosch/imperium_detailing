...
class MeuPontoPage extends StatefulWidget {
  ...
  @override
  State<MeuPontoPage> createState() =>
      _MeuPontoPageState();
}

class _MeuPontoPageState
    extends State<MeuPontoPage> {
  ...
  Future<void> _carregar() async {
    ...
    try {
      final resultados =
        ...
        _repository.obterEstadoBatidaHoje(
      ...
      _mensagem(
        'Não foi possível carregar seu ponto.\n$erro',
        erro: true,
      );
    }
  }
  ...
  Future<void> _bater() async {
    ...
    try {
      final resultado =
          await _repository.registrarBatida(
        colaboradorId:
            widget.colaboradorId,
      );

      final acao =
          (resultado['acao'] ?? 'Batida')
              .toString();
      final hora =
          (resultado['hora'] ?? '')
              .toString();
