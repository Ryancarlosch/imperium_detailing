...
class _WebPrecificacaoPageState extends State<WebPrecificacaoPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final filtrados = _snapshots.where((item) {
      ...
      final atual = _double(item['preco_atual']);
      final equilibrio = _double(item['preco_equilibrio']);
      final alerta = margem < margemMinima || atual < equilibrio;

      if (_filtroPrecificacao == 'Alertas' && !alerta) return false;
      if (_filtroPrecificacao == 'Saudáveis' && alerta) return false;
      if (termo.isEmpty) return true;
      return nome.toLowerCase().contains(termo);
    }).toList()
      ..sort((a, b) {
        final aNome = nomes[a['servico_id']?.toString()] ?? '';
        final bNome = nomes[b['servico_id']?.toString()] ?? '';
        return aNome.toLowerCase().compareTo(bNome.toLowerCase());
      });
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 6),
                  FilledButton.icon(
                    onPressed: config == null ? null : _novaSimulacao,
              ...
              Wrap(
                ...
                children: [
                  ...
                  _resumoPrecificacao(
                    ...
                    detalhe: 'Serviços com snapshot de preço',
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Wrap(
                      ...
                      children: [
                        Text(
                          'Cliente final: ${config['margem_cliente']}%',
                          style: const TextStyle(fontWeight: FontWeight.w800),
                        ),
                        ...
                        Text('Margem mínima: ${config['margem_minima']}%'),
                        Text('Média histórica: ${config['meses_media']} meses'),
                      ],
                    ),
                  ),
                ),
                  ...
                  child: Wrap(
                    ...
                    children: [
                      ...
                      SegmentedButton<String>(
                        ...
                        onSelectionChanged: (value) {
                          setState(
                            () => _filtroPrecificacao = value.first,
                          );
                        },
                      ),
                    ],
                    ...
                    return SizedBox(
                      ...
                      child: Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            'Margem cliente ${item['margem_cliente']}% · '
