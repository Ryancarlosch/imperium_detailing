...
void main() {
  test('acesso do funcionario usa realtime seguro sem expor tabelas sensiveis', () {
    ...
    expect(
      migration,
      contains('auth_user_id = (select auth.uid())'),
    );
    expect(
      migration,
    ...
    expect(
      migration,
      contains('trg_imperium_funcionario_realtime_sinal'),
    );
    ...
    expect(
      ...
      isNot(
        contains(
          'grant select on table public.imperium_funcionario_acessos',
        ),
      ),
    );
    expect(
    ...
    expect(
      inicio,
      contains("Timer.periodic(const Duration(seconds: 90)"),
    );
    expect(
      inicio,
